...
Miután a két megosztott programkönyvtár létrejött, a \code{.exe} fájl mellé másolva használhatjuk az OpenCvSharp szolgáltatásait.

\subsection{Mono telepítése}

A Mono Debian csomagként telepíthető a Linux rendszereken megszokott \code{apt} csomagkezelő program segítségével. A szoftverkönyvtár telepítése után a lefordított végrehajtható programot a \code{mono} parancs kiadásával futtathatjuk, paraméterként megadva a \code{.exe} kiterjesztésű fájlt.
