...
A \emph{Dockerfile} egy szöveges fájl, mely soronként tartalmazza a környezet létrehozásához szükséges utasításokat. A parancssorban a \code{docker build} parancs kiadásával készíthetünk image-et a Dockerfile-ból.
...
A fordítás során a legfrissebb \emph{Debian} image-ből indulunk