...
A naplózási szolgáltatásra a távoli eszköz \code{Subscribe} metódusával iratkozhatnak fel. A feliratkozás során a \code{Channel} objektumot, amin a hívás érkezett, az objektum elmenti egy 
