...
\item \code{InsertOperation(string xml, bool repeatable, int index = -1)} Az előző metódus funkcionalitását egészíti ki egy index argumentummal, ami beszúrandó művelet helyét jelöli ki a listában. Valójában az \code{AddOperation} metódus is ezzel van implementálva, csak az olvashatóság kedvéért került bele redundáns módon a két tagfüggvény.
\end{itemize}
